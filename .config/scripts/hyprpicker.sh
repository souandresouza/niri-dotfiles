...
notify-send -t 5000 "RGB color picked" "rgb($(wl-paste))" -i /tmp/color.png -a "Hyprpicker"
...
# Send a notification using the file as an icon
notify-send -t 5000 "HEX color picked" "$(wl-paste)" -i /tmp/color.png -a "Hyprpicker"
...
# Send a notification using the file as an icon
notify-send -t 5000 "HSV color picked" "hsv($(wl-paste))" -i /tmp/color.png -a "Hyprpicker"
